...
| `SUPABASE_SECRET_KEYS` / `SUPABASE_SERVICE_ROLE_KEY` | `delete-account`; also the two generation functions (live since 2026-09-17), for one telemetry INSERT | **Auto-injected** by the Supabase Edge runtime — no manual setup. Server-only; see below. |
