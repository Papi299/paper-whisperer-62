...
- the Chrome Web Store listing images in `assets/store/` — a 128×128 Store icon
  (the symbol re-fitted to the Store's documented 96 + 16 px transparent
  padding: one uniform scale and one offset, no geometry change), a 440×280
  promo tile, and three 1280×800 screenshots. Generated by
...
Store **promotional video**; favicon wiring; any privacy policy. Nothing here is
