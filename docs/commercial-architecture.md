...
### 4.9c Model-aware reasoning policy and provider activation — schema, frontend and generation Edge LIVE; paid providers LIVE since 2026-09-19; manual reasoning still staged off (AI-MULTI-PROVIDER-001C, C41)
