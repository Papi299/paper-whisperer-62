...
### 4.9c Model-aware reasoning policy and provider activation — schema, frontend and generation Edge LIVE; manual reasoning and paid providers staged off (AI-MULTI-PROVIDER-001C, C41)
