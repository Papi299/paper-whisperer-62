...
> - **Migration only.** `20260925134526_harden_junction_dml_grants.sql` was applied under its own repository version. Ledger **87 → 88**, latest `20260925134526`, present exactly once. That was the whole rollout: no Edge Function was deployed (versions unchanged), and no frontend, Vercel, secret, Auth or Storage action was taken.
