...
#### 6.6a The full AI-MULTI-PROVIDER rollout order (reference — the 001C PR executes none of it; phases 1–3, Phase 6 and the Google part of Phase 7 complete)
