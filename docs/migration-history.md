...
## 2026-08-10 — PFA-C08-SECURITY-HARDENING-001: bounded `search_path` on the four remaining advisor functions (`20260810152125`) — **repository only, not yet applied**

**Repository implementation only.** The migration below is **committed but NOT applied to Production**, and no Supabase Auth setting was changed. Deployment is a separately authorized step; until it runs, the ledger stays at **72 rows** (latest `20260809051802`, Local = Remote).
