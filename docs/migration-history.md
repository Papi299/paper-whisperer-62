...
- **Local verification.** Full migration replay from empty; 933 pgTAP assertions across 11 suites (108 new in suite 010) plus the framework-free verification, concurrency probe and catalog-fingerprint residue checks; 2552 unit tests across 99 files; 155 local E2E tests including five identity acceptance flows and a seed-time cross-user isolation probe over the real Data API; lint at its 0-error baseline; typecheck and build clean.
