...
- **Foundation is not feature.** There is **no Settings control** and **no AI operation consults the preference**. Runtime routing is `AI-MODEL-SELECTION-001B`; the visible Settings control is `AI-MODEL-SELECTION-001C`.
