...
- **Tests.**
  ...
  - **Database:** new pgTAP suite `016_ai_reasoning_policy.test.sql` (93 assertions). Suites 003, 011 and 012 were updated deliberately (classification lists and pinned column/result sets), not loosened. A clean local replay from zero ran 17 suites and 1,644 assertions, **all green**, plus the framework-free 18/18 and the concurrency probes.
