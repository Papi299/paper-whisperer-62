...
- **Production rollout (2026-09-25) — migration only** ([deployment.md](deployment.md) §6.9):
  ...
  - **Migration.** `20260925134526` applied under its repository version, present exactly once. Ledger **87 → 88**, latest `20260925134526`. No Edge Function, frontend, Vercel, secret, Auth or Storage action was part of it.
