...
- **Production data flow:** unchanged. Production runs the pre-001A Google-only artifacts. **Google remains the only AI recipient, and PaperLume does not send data to Anthropic or OpenAI.** No request was sent to either provider during 001B.
